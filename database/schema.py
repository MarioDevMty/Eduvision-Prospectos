...
CREATE TABLE IF NOT EXISTS users (
    ...
    role TEXT NOT NULL CHECK (role IN ('CURADOR', 'ADMIN', 'SUPERADMIN')),
...
CREATE TABLE IF NOT EXISTS campuses (
    ...
    FOREIGN KEY (parent_campus_id) REFERENCES campuses(id),
    FOREIGN KEY (created_by) REFERENCES users(id),
    FOREIGN KEY (updated_by) REFERENCES users(id)
);
...
CREATE INDEX IF NOT EXISTS idx_contacts_campus
ON contacts(campus_id);

CREATE TABLE IF NOT EXISTS phones (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    entity_type TEXT NOT NULL CHECK (entity_type IN ('ORGANIZATION', 'CAMPUS', 'CONTACT')),
...
def create_schema() -> None:
    ...
    Para una base existente con contacts.campus_id NOT NULL, ejecutar antes:
        python scripts/migrate_crud_bloque1_contacts.py
    """
